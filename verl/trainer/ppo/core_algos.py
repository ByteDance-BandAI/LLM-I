...
def compute_policy_loss_gspo(
    ...
    Args:
        ...
        config (dict, optional):
            Configuration dictionary for GSPO. Must contain "clip_ratio_low" and "clip_ratio_high".
    """
    assert config is not None, "config must be provided for GSPO."

    clip_ratio_low = config.get("clip_ratio_low", 3e-4)
    clip_ratio_high = config.get("clip_ratio_high", 4e-4)
