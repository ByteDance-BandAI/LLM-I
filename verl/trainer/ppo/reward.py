...
def load_reward_manager(config, tokenizer, num_examine, **reward_kwargs):
    ...
    # llmi: LLMIRewardManager
    # By default reward_manager is set to llmi (LLMIRewardManager)
    reward_manager_name = config.reward_model.get("reward_manager", "llmi")
    print(f'[DEBUG]: load reward manager {reward_manager_name=}')
